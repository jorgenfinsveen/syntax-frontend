    ...
    <div className='companies-page page-container'>
      ...
      <div className='companies-page__grid-container'>
        <section>
          ...
          <p className='p--regular'>{t('companies.bedpres.footer1')}<a className='standard-link standard-link--underscore-hover' href='mailto:neringsliv@syntax-linjeforening.no'>neringsliv@syntax-linjeforening.no</a>{t('companies.bedpres.footer2')}</p>
        </section>
        <section>
            <div>
                ...
                <p className='p--regular'>{t('companies.cyberdays.footer1')}</p>
            </div>
        </section>
        <section>
          <h2 className='companies-section__header heading-2'>
